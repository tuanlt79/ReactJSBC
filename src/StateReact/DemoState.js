...
export default class DemoState extends Component {
  ...
  state = {
    //this.state là thuộc tính đặc biệt của react class componet, chứa các giá trị thay đổi trên giao diện khi người dùng thao tác
    isLogin: false,
  };
  //   isLogin = false;
  renderLoginTemplate = () => {
  ...
  handleLogin = () => {
    ...
    this.setState({
      isLogin: true,
    }); // this.setState là phương thức có sẵn của react class component dùng để set lại giá trị của biến sate và làm render lại giao diện
  };
