...
export default class BTRenderMap extends Component {
  dataFilm = [
    {
      maPhim: 1321,
      tenPhim: "Ted2",
      ...
      return (
        <div key={index} className="col-4 mt-2">
          <div className="card text-white bg-dark">
            <div
              style={{
                backgroundImage: `url('${phim.hinhAnh}'),url('https://picsum.photos/150/450')`,
